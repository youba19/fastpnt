          ...
          actions: [
            PopupMenuButton(
              itemBuilder: (BuildContext bc) => [
                ...
                PopupMenuItem(child: Text("Sign out"), value: "/SignIn"),
              ],
              onSelected: (route) {
                print(route);
                  ...
                  children: [
                    GestureDetector(
                      onTap: (){
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) =>MedcinProfile(Name: user.displayName,)),
                        );
                      },
                      child: Container(
                        child: CircleAvatar(
              ...
              Container(
                ...
                child: InkWell(
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) =>ListValideM(email: user.email,)),
                    );
                  },
                  child: Row(
              ...
              Padding(
                ...
                child: StreamBuilder(
                  stream: FirebaseFirestore.instance
                      .collection('appointments-doc')
                      .where('email', isEqualTo: user.email.toString() ).where('valide',isEqualTo: false)
                      .snapshots(),
                  builder: (BuildContext context,
