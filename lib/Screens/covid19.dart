import 'dart:convert';
import 'package:fastpnt/Screens/text_field.dart';
import 'package:fastpnt/models/bannerModel.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        elevation: 8.0,
        backgroundColor:Color( 0xFFFb3cde0),
        title: Text(
          'Covid-19 Statistics',
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: LinearGradient(
                            ...
                            colors: bannerCards[1].cardBackground,
                          ),
                        ),
                        width: double.infinity,
                        child: Column(
