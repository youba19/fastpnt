...
import 'package:fastpnt/Screens/prescription.dart';
...
class ListValideM extends StatefulWidget {
  final String email;

  const ListValideM({Key key, this.email}) : super(key: key);
  @override
  _ListValideMState createState() => _ListValideMState();
}

class _ListValideMState extends State<ListValideM> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("RDV Validé",style:TextStyle(color: Colors.black)),
      ...
      body:   Padding(
        ...
        child: StreamBuilder(
          stream: FirebaseFirestore.instance
              ...
              .where('email', isEqualTo: widget.email.toString() ).where('valide',isEqualTo: true).
              snapshots(),
          builder: (BuildContext context,
