...
class UpdateMedcinDetails extends StatefulWidget {
  final String label;
  final String field;
  const UpdateMedcinDetails({Key key, this.label, this.field}) : super(key: key);

  @override
  _UpdateUserDetailsState createState() => _UpdateUserDetailsState();
}

class _UpdateUserDetailsState extends State<UpdateMedcinDetails> {
  ...
  Future<void> updateData() async {
    FirebaseFirestore.instance.collection('Medcin').doc(UserID).set({
